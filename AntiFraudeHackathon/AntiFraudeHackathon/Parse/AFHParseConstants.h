...
extern NSString * const ParseActivityClass;
extern NSString * const ParseActivityCity;
extern NSString * const ParseActivityCreation;
extern NSString * const ParseActivityEvent;
...
@interface AFHParseConstants : NSObject
